        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-600">Share anonymized usage data to improve the product</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { value: 'auto', label: 'Auto', preview: 'bg-gradient-to-r from-white to-gray-900 border-gray-300' }
          ].map(theme => (
            <label key={theme.value} className="cursor-pointer">
              <input
                ...
                className="sr-only peer"
              />
              <div className={`p-4 border-2 rounded-lg peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-gray-400 transition-colors ${theme.preview}`}>
